    ...
    return (
        <div>
            ...
            <form onSubmit={updateHandler.bind(this)}>
                <input onChange={fieldHandler.bind(this)} type="text" placeholder="Title" name="title" defaultValue={post.title}></input>
                <br></br>
                <textarea onChange={fieldHandler.bind(this)} type="text" placeholder="Content" name="content" defaultValue={post.content}></textarea>
                <br></br>
